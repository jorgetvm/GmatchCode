...
import PartidoApp from '../../../Components/PartidoApp';
...
export const PartidoAppPage = () => {
  ...
  return (
    <section className="PartidoAppPage">
      {infopartido_tv && (
      <PartidoApp partido={infopartido_tv} />
      )}
    </section>
  );
};

export default PartidoAppPage;
